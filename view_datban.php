            ...
            <div class="dashboard">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Xem đặt bàn</p>
                            ...
                            <div class="right__tableWrapper">
                                <table>
                                    ...
                                    <?php while ($row = mysqli_fetch_array($query)) : ?>
                                        <tr>
                                            <td data-label="STT"><?php echo $row['id_datban']; ?></td>
                                            <td data-label="Tiêu đề"><?php echo $row['ho_ten']; ?></td>
                                            <td data-label="Mô tả"><?php echo $row['so_dienthoai']; ?></td>
                                            <td data-label="Mô tả"><?php echo $row['so_luong']; ?></td>
                                            <td data-label="Mô tả"><?php echo $row['ghi_chu']; ?></td>
                                            <td data-label="Mô tả"><?php echo $row['trang_thai']; ?></td>
                                            <td data-label="Sửa" class="right__iconTable"><a href="models/edit_datban.php?iddatban=<?php echo $row['id_datban']; ?>"><img src="assets/icon-check.svg" alt=""></a></td>
                                            <td data-label="Xoá" class="right__iconTable"><a href="models/xuly_datban.php?iddatban=<?php echo $row['id_datban']; ?>"><img src="assets/icon-trash-black.svg" alt=""></a></td>
                                        </tr>
                                    <?php endwhile; ?>
                                    </tbody>
                                </table>
