            ...
            <div class="dashboard">
                        ...
                        <ul class="left__menu">
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    ...
                                    <a class="left__link" href="view_khuyenmai.php">Xem Danh Mục</a>
                                </div>
                            </li>
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    ...
                                    <a class="left__link" href="view_danhmuc.php">Xem khuyến mại</a>
                                </div>
                            </li>
                            <li class="left__menuItem">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Xem tài khoản</p>
                            ...
                            <div class="right__tableWrapper">
                                <table>
                                    ...
                                    <?php while ($row = mysqli_fetch_array($query)) : ?>
                                        <tr>
                                            <td data-label="STT"><?php echo $row['id_taikhoan']; ?></td>
                                            <td data-label="Tên tài khoản"><?php echo $row['username']; ?></td>
                                            <td data-label="Họ tên"><?php echo $row['ho_ten']; ?></td>
                                            <td data-label="Email"><?php echo $row['email']; ?></td>
                                            <td data-label="Địa chỉ"><?php echo $row['dia_chi']; ?></td>
                                            <td data-label="Phone"><?php echo $row['so_phone']; ?></td>
                                            <td data-label="Trạng thái"><?php echo $row['trang_thai']; ?></td>
                                            <td data-label="Sửa" class="right__iconTable"><a href="models/edit_taikhoan.php?mataikhoan=<?php echo $row['id_taikhoan']; ?>"><img src="assets/icon-edit.svg" alt=""></a></td>
                                            <td data-label="Xoá" class="right__iconTable"><a href="models/xuly_taikhoan.php?mataikhoan=<?php echo $row['id_taikhoan']; ?>"><img src="assets/icon-trash-black.svg" alt=""></a></td>
                                        </tr>   
                                    <?php endwhile; ?>      
                                    </tbody>
                                </table>
