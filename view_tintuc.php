...
include "connect.php";
session_start();
$sql = "SELECT * FROM tin_tuc INNER JOIN danh_muc ON tin_tuc.ma_danhmuc = danh_muc.ma_danhmuc";
                            ...
                            <div class="right__tableWrapper">
                                <table>
                                    ...
                                    <?php while ($row = mysqli_fetch_array($query)) : ?>
                                        <tr>
                                            <td data-label="STT"><?php echo $row['id_tintuc']; ?></td>
                                            <td data-label="Tiêu đề">
                                                <img src="models/Uploads/<?php echo $row['hinh_anh']; ?>" alt="" width= "90px;" height="80px;">
                                            </td>
                                            <td data-label="Mô tả"><?php echo $row['tieude_tintuc']; ?></td>
                                            <td data-label="Mô tả" style="text-align: justify;"><?php echo mysubstr($row['noi_dung']) ?></td>
                                            <td data-label="Sửa" class="right__iconTable"><a href="models/edit_tintuc.php?idtintuc=<?php echo $row['id_tintuc']; ?>"><img src="assets/icon-edit.svg" alt=""></a></td>
                                            <td data-label="Xoá" class="right__iconTable"><a href="models/edit_tintuc.php?idtintuc=<?php echo $row['id_tintuc']; ?>"><img src="assets/icon-trash-black.svg" alt=""></a></td>
                                        </tr>
                                    <?php endwhile; ?>
                                    </tbody>
                                </table>
...
<?php
function mysubstr($str,$limit=150){
