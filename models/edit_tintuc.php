<?php
    include "../connect.php";
    $sql_sua = "SELECT * FROM tin_tuc WHERE id_tintuc='$_GET[idtintuc]' LIMIT 1";
    $query = mysqli_query($conn, $sql_sua);
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="dashboard">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Sửa tin tức</p>
                        <div class="right__formWrapper">
                            <form action="xuly_tintuc.php?idtintuc=<?php echo $_GET['idtintuc'] ?>" method="POST"  enctype="multipart/form-data">
                            <?php
                            ...
                            ?>
                                <div class="right__inputWrapper">
                                    ...
                                    <img src="Uploads/<?php echo $row['hinh_anh']; ?>" alt="" width= "90px;" height="100px;">
                                </div>
                                <div class="right__inputWrapper">
                                    <label for="product">Tiêu đề</label>
                                    <input type="text" value="<?php echo $row['tieude_tintuc']?>" name="tieude" />
                                </div>
                                <div class="right__inputWrapper">
                                    <label for="product">Nội dung</label>
                                    <textarea type="text" name="noidung" cols="30" rows="20"><?php echo $row['noi_dung'] ?></textarea>
                                </div>
                                <button class="btn" type="submit" name="suatintuc">Cập nhật</button>
                            <?php } ?>
                            </form>
                        </div>
                    </div>
