            ...
            <div class="dashboard">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Thêm thực đơn</p>
                        <div class="right__formWrapper">
                            <form action="xuly_km.php" method="POST" enctype="multipart/form-data">
                                <div class="right__inputWrapper">
                                    <label for="product">Tên SP</label>
                                    <input type="text" placeholder="Tiêu đề" name="tensanpham">
                                </div>
                                <button class="btn" type="submit" name="themthucdon">Thêm</button>
