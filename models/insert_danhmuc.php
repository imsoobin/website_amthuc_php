            ...
            <div class="dashboard">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Thêm mới danh mục</p>
                        <div class="right__formWrapper">
                            <form action="xuly_dm.php" method="POST" enctype="multipart/form-data">
                                <div class="right__inputWrapper">
                                    <label for="title">Tiêu đề danh mục</label>
                                    <input type="text" placeholder="Tiêu đề" name="tendanhmuc">
                                </div>
                                <div class="right__inputWrapper">
                                    <label for="desc">Mô tả danh mục</label>
                                    <textarea name="motadanhmuc" id="" cols="30" rows="10" placeholder="Mô tả"></textarea>
                                </div>
                                <button class="btn" type="submit" name="themdanhmuc">Thêm danh mục</button>
                            </form>
                        </div>
                    </div>
                </div>
