<?php
    include"../connect.php";
    $sql = "SELECT * FROM mon_an LIMIT 1";
            ...
            <div class="dashboard">
                <div class="left">
                    ...
                    <div class="left__content">
                        ...
                        <ul class="left__menu">
                            ...
                            <li class="left__menuItem">
                                <a href="../view_taikhoan.php" class="left__title"><img src="assets/icon-users.svg" alt="">Khách Hàng</a>
                            </li>
                            <li class="left__menuItem">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Thêm mới khuyến mại</p>
                        <div class="right__formWrapper">
                            
                            <form action="xuly_khuyenmai.php" method="POST" enctype="multipart/form-data">
                                <div class="right__inputWrapper">
                                    <label for="title">Tiêu đề khuyến mại</label>
                                    <textarea type="text" name="tieude" cols="20" rows="20"></textarea>
                                </div>
                                <div class="right__inputWrapper">
                                    ...
                                    ?>
                                        ...
                                        <option value="<?php echo $row['ten_doan'] ?>"><?php echo $row['ten_doan'] ?></option>
                                    <?php  } ?>
                                    </select>
                                ...
                                <div class="right__inputWrapper">
                                    ...
                                    <input type="text" name="apdung">
                                </div>
                                <button class="btn" type="submit" name="themkhuyenmai">Thêm khuyến mại</button>
                            </form>
                        </div>
                    </div>
                </div>
