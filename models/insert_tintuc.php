            ...
            <div class="dashboard">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Thêm mới tin tức</p>
                        <div class="right__formWrapper">
                            <form action="xuly_tintuc.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="right__inputWrapper">
                                    ...
                                    <textarea name="noidung" id="" cols="30" rows="18"></textarea>
                                </div>
                                <button class="btn" type="submit" name="themtintuc">Thêm tin tức</button>
                            </form>
                        </div>
                    </div>
                </div>
