<?php
    include"../connect.php";
    $sql = "SELECT * FROM khuyen_mai WHERE id_khuyenmai = '$_GET[idkhuyenmai]'";
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <?php
                            ...
                            ?>
                            <form method="POST" action="xuly_khuyenmai.php?idkhuyenmai=<?php echo $row['id_khuyenmai'] ?>">
                                <div class="right__inputWrapper">
                                    <label for="password">Tiêu đề </label>
                                    <textarea type="text" name="tieude" cols="20" rows="20"><?php echo $row['tieu_de']?></textarea>
                                </div>
                                <div class="right__inputWrapper">
                                    <label for="password">Áp dụng</label>
                                    <input type="text" name="apdung" value="<?php echo $row['ap_dung'] ?>">
                                </div>
                                <div class="right__inputWrapper">
                                ...
                                <button class="btn" type="submit" name="suakhuyenmai">Cập nhật khuyến mại</button>
                            </form>
                            <?php } ?> 
                        </div>
                    </div>
