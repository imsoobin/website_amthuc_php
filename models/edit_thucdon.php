<?php
    include "../connect.php";
    $sql_sua = "SELECT * FROM thuc_don WHERE id_thucdon='$_GET[idthucdon]' LIMIT 1";
            ...
            <div class="dashboard">
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <p class="right__desc">Sửa thực đơn</p>
                        <div class="right__formWrapper">
                            <form action="xuly_km.php?idthucdon=<?php echo $_GET['idthucdon'] ?>" method="POST">
                            <?php
                                while($row = mysqli_fetch_array($query)) {
                            ?>
                                <div class="right__inputWrapper">
                                    <label for="product">Tên sản phẩm</label>
                                    <input type="text" value="<?php echo $row['ten_sp']?>" name="tensanpham" />
                                </div>
                                <button class="btn" type="submit" name="suathucdon">Cập nhật</button>
                            <?php } ?>
                            </form>
                        </div>
                    </div>
