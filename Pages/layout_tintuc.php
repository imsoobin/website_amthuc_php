<?php
    ...
    $sql_tt = "SELECT * FROM tin_tuc WHERE id_tintuc = '$_GET[idtintuc]' LIMIT 1";
...
<body>
    ...
    <?php while($row = mysqli_fetch_array($query_tt)){  ?>
        <div class="tieude">
            <?php echo $row['tieude_tintuc'] ?>
        </div>
        <div class="noidung">
            <?php echo $row['noi_dung'] ?>
        </div>
        <div class="" style="display: flex; justify-content: center; align-items: center;">
            <img src="../models/Uploads/<?php echo $row['hinh_anh'] ?>" alt="" width="500px" height="400px">
        </div>
        <div class="tieude">
