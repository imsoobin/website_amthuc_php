                                ...
                                <table>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td data-label="Tên tài khoản"><?php echo $row['tieu_de']; ?></td>
                                            <td data-label="Mật khẩu"><?php echo $row['ten_sanpham']; ?></td>
                                            <td><?php echo $row['ap_dung']; ?></td>
                                            <td data-label="Sửa" class="right__iconTable"><a href="models/edit_khuyenmai.php?idkhuyenmai=<?php echo $row['id_khuyenmai']; ?>"><img src="assets/icon-edit.svg" alt=""></a></td>
                                            <td data-label="Xoá" class="right__iconTable"><a href="models/xuly_khuyenmai.php?idkhuyenmai=<?php echo $row['id_khuyenmai']; ?>"><img src="assets/icon-trash-black.svg" alt=""></a></td>
                                        </tr>   
                                    <?php } ?>      
                                    </tbody>
                                </table>
